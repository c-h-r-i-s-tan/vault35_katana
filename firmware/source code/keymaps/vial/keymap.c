...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all(
    ...
    KC_NO,     KC_TAB,     LT(1,KC_ENTER),           XXXXXXX,             LT(2,KC_SPC),             KC_BSPC,    KC_NO
  ),
  ...
  [1] = LAYOUT_all(
    ...
    KC_NO,    KC_NO,    KC_TRNS,  XXXXXXX,   MO(4),   KC_0,      KC_DOT
  ),
  ...
  [2] = LAYOUT_all(
    ...
    KC_NO,    KC_NO,  MO(4),    XXXXXXX,  KC_TRNS,   KC_NO,     KC_NO
  ),

  [3] = LAYOUT_all(

    KC_LPRN,    KC_NO,  KC_NO,    KC_NO,      KC_NO,      KC_NO,    KC_NO,    KC_NO,    KC_NO,     KC_RPRN,
    KC_LCBR,    KC_NO,  KC_NO,    KC_NO,    KC_NO,        KC_NO,    KC_NO,    KC_NO,    KC_DQT,    KC_RCBR,
    KC_LBRC,    KC_NO,  KC_NO,    KC_NO,      KC_NO,      KC_NO,    KC_NO,    KC_SCLN,  KC_COLN,   KC_RBRC,
    KC_NO,      KC_NO,  KC_NO,    XXXXXXX,    C_NO,       KC_NO,    KC_NO
  ),
  ...
  [4] = LAYOUT_all(
    ...
    KC_NO,  KC_NO,  KC_TRNS,  XXXXXXX,  KC_TRNS,  KC_NO,  KC_NO
  ),
